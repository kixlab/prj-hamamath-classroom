...
export const SubQs = () => {
  const { currentCotData, currentGuidelineData, setCurrentGuidelineData, setCurrentStep, setLoading, setError, loading, error } = useApp();
          ...
          return (
            <div key={subQ.sub_question_id} className={styles.subQuestionCard}>
              ...
              <div className={styles.actionButtons}>
                ...
                <button className={styles.actionBtn} onClick={() => toggleFeedback(subQ.sub_question_id)}>
                  <span>💬</span>
                  <span>피드백</span>
                </button>
                {isFeedbackOpen && (
