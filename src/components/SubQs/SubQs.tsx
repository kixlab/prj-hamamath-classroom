...
import { exportPdfFromSubQuestion } from "../../utils/exportPdf";
...
export const SubQs = () => {
  ...
  const handleExportWord = async () => {
    ...
    try {
      await api.exportWordFromSubQuestion(currentCotData as any, finalizedSubQuestionForRubric, {}, currentProblemId);
    } catch (err: any) {
  ...
  const handleExportPdf = async () => {
    if (!currentCotData || !finalizedSubQuestionForRubric) return;
    try {
      await exportPdfFromSubQuestion(
